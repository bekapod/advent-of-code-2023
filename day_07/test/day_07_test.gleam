...
pub fn compare_hands_equal_test() {
  day_07.compare_hands(#("23456", 123, HighCard), #("23456", 123, HighCard))
  |> should.equal(order.Eq)
}

pub fn compare_hands_greater_test() {
  day_07.compare_hands(#("AAAAA", 123, FiveOfAKind), #("23456", 122, HighCard))
...
pub fn compare_hands_less_test() {
  day_07.compare_hands(#("23456", 123, HighCard), #("AAAAA", 122, FiveOfAKind))
