...
pub fn parse_game_rounds_test() {
  day_02.parse_game_rounds("3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green")
  |> should.equal([
...
pub fn parse_game_rounds_empty_test() {
  day_02.parse_game_rounds("")
  |> should.equal([dict.from_list([])])
}
